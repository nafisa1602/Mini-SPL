...
| **Strategy Pattern (Risk Scoring & Hashing)** | [`RiskScoringStrategy`](src/main/java/com/minispl/application/strategy/RiskScoringStrategy.java), [`CvssRiskScoringStrategy`](src/main/java/com/minispl/application/strategy/CvssRiskScoringStrategy.java), [`NistRiskScoringStrategy`](src/main/java/com/minispl/application/strategy/NistRiskScoringStrategy.java), [`RiskScoringContext`](src/main/java/com/minispl/application/strategy/RiskScoringContext.java), [`HashingStrategy`](src/main/java/com/minispl/application/strategy/HashingStrategy.java), [`Sha256HashingStrategy`](src/main/java/com/minispl/application/strategy/Sha256HashingStrategy.java), [`Sha512HashingStrategy`](src/main/java/com/minispl/application/strategy/Sha512HashingStrategy.java), [`HashingContext`](src/main/java/com/minispl/application/strategy/HashingContext.java) | Enables pluggable algorithms interchangeable at runtime: (1) Risk scoring (CVSS v3.1 mathematical scoring vs. NIST SP 800-61 criticality matrices) and (2) Cryptographic file hashing (SHA-256 for rapid integrity checks vs. SHA-512 for high-assurance court admissibility). |
